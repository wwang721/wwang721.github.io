...
* Windows 系统稍微麻烦一些，而且注意 Windows 路径使用的是<font color="#26975b"><b>反斜杠</b></font> `\` 分隔:<br><br>
	...
	* Python 可以到 [***<u>https://www.python.org</u>***](https://www.python.org) 官网下载，也可以直接下载 [**Anaconda**](https://www.anaconda.com) 进行配置，注意在 Windows 的 **PowerShell** 里不能 `conda activate base` 激活 base 环境， 打开 **CMD** 执行该命令即可。
