...
As well, I'd like to give an example first. However, it's a little more complicated than **Python** [**NumPy**](https://numpy.org) and [**pandas**](https://pandas.pydata.org), you have to understand some **C++** concepts like **vector** and **stream**, etc.
