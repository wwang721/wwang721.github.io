...
<div class="row" style="margin: 27px 0px 0px -20px;">
<ul id="homepage" style="float:left; border: 0px solid green;">
<li>
 <p style="display:inline;"><b>Visit new minimalist homepage: &ensp;</b></p>
<span style="white-space: nowrap;">
<svg style="margin:0px 2px -4px -8px" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="100 100 180 180" width="23" height="23">
  <defs>
    <style>
      .cls-1 {
        fill: #fca326;
...
<a href="https://wwang721.gitlab.io">https://wwang721.gitlab.io</a>
</span>
</li>
</ul>
</div>
...
<p style="margin:0px 0px -40px 0px">&ensp;</p>
